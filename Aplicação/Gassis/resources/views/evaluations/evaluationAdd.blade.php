...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="card-header">Cadastrar Adaptação
      ...
      {!! Form::open(['class'=>'form','route' => 'evaluation.store', 'method' => 'post', 'enctype'=>'multipart/form-data']) !!}
          ...
          <div class="cols" style="flex-direction:column-reverse">
            ...
            <div class="form-col-2" style="width:100%">

              <div class="form-group">
                <div class="form-label-group">
                  <textarea style="height:33ch" id="inputObservacao" class="form-control" type="text" name="observacao" placeholder="Descreva a adaptação necessária"  maxlength="1000" autofocus="autofocus"></textarea>
                </div>
              </div>
            </div>
          ...
          <input style="visibility:hidden;width:0;height:0;" type="number" name="productionId" value="{{ $production->id }}">

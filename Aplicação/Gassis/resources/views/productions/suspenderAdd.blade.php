...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="card-header">Suspender Produção
          ...
          {{ csrf_field() }}
              ...
              <div class="form-group">
                <div class="form-label-group">
                  <textarea style="height:33ch" id="inputObservacao" class="form-control" type="text" name="descricao" placeholder="Descreva o motivo da suspensão"  maxlength="1000" autofocus="autofocus"></textarea>
                </div>
              </div>
